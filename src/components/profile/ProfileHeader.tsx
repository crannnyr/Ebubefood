import { Settings, Bell, Crown, Sun, Moon } from 'lucide-react';
      ...
      <div className="max-w-[1400px] mx-auto flex items-start justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            <div className="w-16 h-16 rounded-full p-0.5 flex-shrink-0"
              ...
              {avatarUrl ? (
                ...
                <div className="w-full h-full rounded-full flex items-center justify-center font-bold text-lg text-white"
          ...
          <div>
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full mt-2"
              ...
              <span className="text-[11px] font-semibold" style={{ color: '#fbbf24' }}>{memberTier}</span>
            </div>
          </div>
        </div>
